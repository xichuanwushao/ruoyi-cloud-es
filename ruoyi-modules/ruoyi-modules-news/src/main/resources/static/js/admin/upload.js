    ...
    $(function () {
        ...
        uploader.onUploadSuccess = function (file, response) {
            ...
            $("#upload-cover-container").append(
                '<div style="overflow:hidden; float: left; margin: 2px; padding: 2px; border: 1px dashed; width:' +
                ' 120px; height: 100px;">' +
                '<span><img style="width:100%;height:100%;" src="http://r9sushvt6.bkt.clouddn.com/' + photo_path + '" title="待选封面" />' +
